...
<div class="bg-white border border-slate-100 rounded-3xl p-8 shadow-sm flex flex-col items-center justify-center text-center space-y-4 min-h-[400px]">
    ...
    <div class="space-y-2 max-w-md">
        <h3 class="text-sm font-extrabold text-slate-800 uppercase tracking-wider">Portofoliu Proiecte</h3>
        <p class="text-xs text-slate-450 leading-relaxed font-semibold">
            Modul în curs de dezvoltare (Planificat pentru Faza 5). Aici vei putea administra galeriile foto și detaliile tehnice ale lucrărilor finalizate de Optera Vision.
        </p>
    </div>
    <div class="pt-2">
